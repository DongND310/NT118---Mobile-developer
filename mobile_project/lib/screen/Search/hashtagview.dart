                    ...
                    Column(
                      ...
                      children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(widget.hashtag, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                            Text("Bài đăng của 118K", style: TextStyle(fontSize: 15,color: Colors.black38))
                          ],
                        ),
                        Row(
                          children: [
                              ...
                              child: SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text("Thêm vào yêu thích", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),)
                                  ],
                                ),
                              ),
                            )
